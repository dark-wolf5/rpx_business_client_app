...
export class EmailConfirmationComponent implements OnInit {
  ...
  public sendCodeCallback(httpResponse: any) {
    ...
    } else console.log("sendCodeCallback", httpResponse);
  ...
  public checkCode(): void {
    ...
    this.emailConfirmationService
      .checkCode(this.confirmationCode, this.rpxEmail)
      .subscribe((resp) => {
  ...
  public checkCodeCallback(httpResponse: any): void {
    ...
    if (httpResponse.success) {
      ...
      } else this.emailConfirmationPassed = false;
    } else this.emailConfirmationPassed = false;
  }

  public changeParentEmail(): void {
    this.emailAddressChange.emit(this.rpxEmail);
  }
  ...
  get rpxEmail() {
    return this.confirmEmailForm.get("rpxEmail").value;
  }
  ...
  public initEmailForm(): void {
    ...
    this.confirmEmailForm.get("rpxEmail").setValue(this.providedEmail);
  }
