  ...
  implements OnInit, AfterViewInit, OnChanges
{
  ...
  async getHeaderBanner() {
    ...
    accountType = await Preferences.get({ key: "rpx_userType" });
    ...
    this.adsService
      ...
      .subscribe((resp) => this.getHeaderBannerAdCallback(resp));
  }
  ...
  getAdWrapperClass() {
    if (this.desktopPreview) return "rpx-ad-wrapper-header";
    if (this.mobilePreview) return "rpx-ad-wrapper-header sb-mobileAdWrapper";
  }
}
