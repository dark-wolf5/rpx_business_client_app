...
export class QrShortComponent implements OnInit {
  ...
  redeemableItem$ = new BehaviorSubject<{
  ...
  addLp() {
    const c = confirm(
      `Are you sure you want to award ${this.user$.getValue().rpx_user.first_name} with ${this.totalSpent} Loyalty Points?`,
    );
